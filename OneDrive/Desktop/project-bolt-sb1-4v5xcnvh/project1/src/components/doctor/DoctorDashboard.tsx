...
import { Calendar, Users, FileText, Clock, Activity, Video, Phone } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  {[
                    { action: 'Completed consultation', patient: 'Patient #9876', time: '1:30 PM' },
                    { action: 'Prescribed medication', patient: 'Patient #5432', time: '1:15 PM' },
                    { action: 'Updated slot availability', patient: '', time: '12:45 PM' },
                  ].map((activity, index) => (
